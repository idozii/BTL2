...
{ // global
    ...
    Configuration *config = new Configuration("game_config.txt");
...
public:
    ...
    static void satc_01()
    {
        ...
        // cout << "sherlock init exp: " << sherlock->getExp() << endl;
        cout << sherlock->str() << endl;

        Watson *watson = new Watson(2, "LU", Position(3, 0), map, 300, 610);
        // cout << "watson init exp: " << watson->getExp() << endl;
        ...
        // delete arr_mv_objs;
        // cout << "arr_mv_objs deleted" << endl;
        // delete sherlock;
        // cout << "sherlock deleted" << endl;
        // delete watson;
        // cout << "watson deleted" << endl;
        // delete criminal;
        // cout << "criminal deleted" << endl;
        arr_mv_objs->~ArrayMovingObject();
        delete map;
    ...
    static void satc_03()
    {
        ...
        RobotSW *robotSW = new RobotSW(3, Position(6, 2), map, SW, criminal, sherlock, watson);
